 ...
 * @path        Modules/GolonganDarah/Controllers/GolonganDarahController.php
...
namespace Modules\GolonganDarah\Controllers;

use App\Support\MasterData\AbstractMasterDataController;
use App\Support\MasterData\AbstractMasterDataService;
use Illuminate\Http\JsonResponse;
use Modules\GolonganDarah\Requests\StoreGolonganDarahRequest;
use Modules\GolonganDarah\Requests\UpdateGolonganDarahRequest;
use Modules\GolonganDarah\Resources\GolonganDarahResource;
use Modules\GolonganDarah\Services\GolonganDarahService;
