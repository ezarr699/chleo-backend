 ...
 * @path        Modules/ProfilNakes/Controllers/ProfilNakesController.php
...
namespace Modules\ProfilNakes\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Modules\ProfilNakes\Requests\StoreProfilNakesRequest;
use Modules\ProfilNakes\Requests\UpdateProfilNakesRequest;
use Modules\ProfilNakes\Resources\ProfilNakesResource;
use Modules\ProfilNakes\Services\ProfilNakesService;
