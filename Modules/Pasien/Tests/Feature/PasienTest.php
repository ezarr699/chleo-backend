 ...
 * @layer       Test > Feature
 * @file        PasienTest.php
 * @path        Modules/Pasien/Tests/Feature/PasienTest.php
 ...
 * @covers      Modules/Pasien/Controllers/PasienController.php
 * @covers      Modules/Pasien/Services/PasienService.php
...
it('verifies pasien with wilayah administratif lengkap', function () {
    ...
    $provinsi = \Modules\Wilayah\Models\Provinsi::query()->first();
    $kabupaten = \Modules\Wilayah\Models\Kabupaten::query()->where('province_code', $provinsi->code)->first();
    $kecamatan = \Modules\Wilayah\Models\Kecamatan::query()->where('city_code', $kabupaten->code)->first();
    $kelurahan = \Modules\Wilayah\Models\Kelurahan::query()->where('district_code', $kecamatan->code)->first();
