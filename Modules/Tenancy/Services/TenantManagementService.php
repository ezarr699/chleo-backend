...
final class TenantManagementService
{
    ...
    {
        return $this->tenantRepository->paginate($perPage, $status, $sortOrder);
    }
     ...
     */
    public function updateAdminDetails(string $id, array $admin): Tenant
    {
        return $this->tenantRepository->updateAdminDetails($this->find($id), $admin);
    }
